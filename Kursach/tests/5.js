...
ICAL.design = (function() {
  ...
  var FROM_ICAL_NEWLINE = RegExp("/\\\\|\\;|\\,|\\[Nn]/g");
  var TO_ICAL_NEWLINE = RegExp("/\\|;|,|\n/g");
  var FROM_VCARD_NEWLINE = RegExp("/\\\\|\\,|\\[Nn]/g");
  var TO_VCARD_NEWLINE = RegExp("/\\|,|\n/g");
  ...
  var vcardValues = ICAL.helpers.extend(commonValues, {
    ...
    "language-tag": {
      matches: RegExp("/^[a-zA-Z0-9\-]+$/") // Could go with a more strict regex here
    }
  });
...
ICAL.parse = (function() {
  ...
  parser._rfc6868Escape = function(val) {
    return val.replace(RegExp("/\^['n^]/g"), function(x) {
      return RFC6868_REPLACE_MAP[x];
    });
  };
...
(function() {
  var DURATION_LETTERS = RegExp("/([PDWHMTS]{1,1})/");
...
(function() {
  ...
  var VALID_DAY_NAMES = RegExp("/^(SU|MO|TU|WE|TH|FR|SA)$/");
  var VALID_BYDAY_PART = RegExp("/^([+-])?(5[0-3]|[1-4][0-9]|[1-9])?(SU|MO|TU|WE|TH|FR|SA)$/");
...
ICAL.RecurIterator = (function() {
  ...
  icalrecur_iterator.prototype = {
    ...
    ruleDayOfWeek: function ruleDayOfWeek(dow) {
      var matches = dow.match(RegExp("/([+-]?[0-9])?(MO|TU|WE|TH|FR|SA|SU)/"));
      if (matches) {
